...
extract_version() {
    ...
    case "${OPENLDAP_UPGRADE_MIGRATION_LEVEL}" in
        ...
        *) container log fatal "Unknow OPENLDAP_UPGRADE_MIGRATION_LEVEL: ${OPENLDAP_UPGRADE_MIGRATION_LEVEL}. Must be patch, minor or major" ;;
    esac
}
...
write_version() {
    container log info "Writing OpenLDAP version ${OPENLDAP_VERSION} to ${OPENLDAP_UPGRADE_CONF_VERSION_FILE} ..."
